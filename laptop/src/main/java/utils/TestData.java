...
public class TestData {
    ...
    public static final short TARGET_X = 50;
    public static final short TARGET_Y = 30;
    public static final float TARGET_ANGLE = 13.4f;
    public static final float TARGET_RELATIVE_ANGLE = 11.4f;
    public static final short TARGET_DISTANCE = 200;
    public static final float MAIN_SAIL_TARGET_ANGLE = 16.3f;
    ...
    public static SensorData getTestSensorData() {
        return new SensorData(ERROR, STATE_CLIFTON, WAYPOINT, WIND_DIRECTION, WIND_SPEED, WING_SURFACE, VELOCITY, X, Y,
                HEADING, LATITUDE, LONGITUDE, TARGET_X, TARGET_Y, TARGET_ANGLE, TARGET_RELATIVE_ANGLE, TARGET_DISTANCE, MAIN_SAIL_TARGET_ANGLE);
    }
}
